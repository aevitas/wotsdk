...
class _PlayerEvents(object):
    ...
    def __init__(self):
        ...
        self.onEnqueuedHistorical = Event.Event()
        self.onDequeuedHistorical = Event.Event()
        self.onEnqueueHistoricalFailure = Event.Event()
        ...
        self.onKickedFromHistoricalQueue = Event.Event()
