...
if not sum([IS_CHINA,
 ...
 IS_SINGAPORE]) <= 1:
    ...
    ARENA_GAMEPLAY_NAMES = ('ctf', 'domination', 'assault', 'nations', 'ctf2', 'domination2', 'assault2', 'fallout', 'fallout2', 'fallout3', 'fallout4', 'fallout5', 'fallout6')
    ...
    class ARENA_GUI_TYPE_LABEL:
        LABELS = {ARENA_GUI_TYPE.UNKNOWN: 'special',
         ...
         ARENA_GUI_TYPE.EVENT_BATTLES: 'fallout',
    ...
    class ARENA_BONUS_TYPE_CAPS:
        ...
        REGULAR = RESULTS | DAMAGE_VEHICLE | CREDITS | CREDITS_FACTOR_15X15 | XP | XP_FACTOR_15X15 | REWARD_FOR_ACHIEVEMENT | QUESTS | DOSSIER_TOTAL | DOSSIER_KILL_LIST | DOSSIER_15X15 | DOSSIER_ACHIEVEMENTS_15X15 | DOSSIER_MAX15X15 | TKILL_RATING | REF_SYSTEM_BONUS | DAILY_MULTIPLIED_XP | RENT_BATTLES_COUNTED
        TRAINING = RESULTS
        COMPANY = RESULTS | DAMAGE_VEHICLE | CREDITS | CREDITS_FACTOR_15X15 | XP | XP_FACTOR_15X15 | RANSOM_IN | RANSOM_OUT | QUESTS | DOSSIER_TOTAL | DOSSIER_KILL_LIST | DOSSIER_15X15 | DOSSIER_COMPANY | DOSSIER_MAX15X15 | TKILL_RATING | DAILY_MULTIPLIED_XP | RENT_BATTLES_COUNTED
        TOURNAMENT = RESULTS | TKILL_RATING
        CLAN = RESULTS | DAMAGE_VEHICLE | CREDITS | CREDITS_FACTOR_15X15 | XP | XP_FACTOR_15X15 | RANSOM_IN | RANSOM_OUT | QUESTS | DOSSIER_TOTAL | DOSSIER_KILL_LIST | DOSSIER_15X15 | DOSSIER_CLAN | TKILL_RATING | DAILY_MULTIPLIED_XP | RENT_BATTLES_COUNTED
        ...
        TUTORIAL = 0
        CYBERSPORT = RESULTS | DAMAGE_VEHICLE | CREDITS | CREDITS_FACTOR_7X7 | XP | XP_FACTOR_7X7 | RANSOM_IN | QUESTS | DOSSIER_TOTAL | DOSSIER_KILL_LIST | DOSSIER_7X7 | DOSSIER_MAX7X7 | CYBERSPORT_RATING | DOSSIER_ACHIEVEMENTS_7X7 | TKILL_RATING | DAILY_MULTIPLIED_XP | RENT_BATTLES_COUNTED
        HISTORICAL = RESULTS | DAMAGE_VEHICLE | CREDITS | CREDITS_FACTOR_15X15 | XP | XP_FACTOR_15X15 | QUESTS | DOSSIER_KILL_LIST | DOSSIER_HISTORICAL | DOSSIER_ACHIEVEMENTS_HISTORICAL | DOSSIER_MAXHISTORICAL | TKILL_RATING | DAILY_MULTIPLIED_XP | RENT_BATTLES_COUNTED
        EVENT_BATTLES = RESULTS | DAMAGE_VEHICLE | CREDITS | XP | QUESTS | RESPAWN | INTERACTIVE_STATS | FLAG_MECHANICS | WIN_POINTS_MECHANICS | REPAIR_MECHANICS | TKILL_RATING | MULTITEAMS | RAGE_MECHANICS | RESOURCE_POINTS | DAILY_MULTIPLIED_XP | RENT_BATTLES_COUNTED
        SORTIE = RESULTS | DAMAGE_VEHICLE | CREDITS | XP | RANSOM_IN | RANSOM_OUT | DOSSIER_TOTAL | DOSSIER_KILL_LIST | DOSSIER_SORTIE | DOSSIER_MAXSORTIE | DOSSIER_ACHIEVEMENTS_SORTIE | FORT_RESOURCE | INFLUENCE_POINTS | QUESTS | TKILL_RATING | DAILY_MULTIPLIED_XP | RENT_BATTLES_COUNTED
        FORT_BATTLE = RESULTS | DAMAGE_VEHICLE | CREDITS | XP | RANSOM_IN | RANSOM_OUT | DOSSIER_TOTAL | DOSSIER_KILL_LIST | FORT_BATTLE_RESULTS | DOSSIER_FORT_BATTLE | DOSSIER_MAXFORTBATTLE | QUESTS | TKILL_RATING | DAILY_MULTIPLIED_XP | RENT_BATTLES_COUNTED
        RATED_CYBERSPORT = RESULTS | DAMAGE_VEHICLE | CREDITS | CREDITS_FACTOR_7X7 | XP | XP_FACTOR_7X7 | RANSOM_IN | QUESTS | DOSSIER_TOTAL | DOSSIER_KILL_LIST | TKILL_RATING | DOSSIER_RATED7X7 | DOSSIER_MAXRATED7X7 | CYBERSPORT_RATING | DOSSIER_CLUB | DOSSIER_ACHIEVEMENTS_RATED7X7 | RENT_BATTLES_COUNTED
        DOSSIER_ACHIEVEMENTS = DOSSIER_ACHIEVEMENTS_7X7 | DOSSIER_ACHIEVEMENTS_15X15 | DOSSIER_ACHIEVEMENTS_SORTIE | DOSSIER_ACHIEVEMENTS_HISTORICAL | DOSSIER_ACHIEVEMENTS_RATED7X7
        ...
        @staticmethod
        def init():
            for caps in ARENA_BONUS_TYPE_CAPS.__typeToCaps.itervalues():
    ...
    class FALLOUT_BATTLE_TYPE:
        UNDEFINED = 0
        CLASSIC = 1
        MULTITEAM = 2
        ALL = (CLASSIC, MULTITEAM)
...
class OVERTURN_CONDITION:
    ...
    ON_SIDE_COSINE = math.cos(math.radians(80))
    ON_TURRET_COSINE = math.cos(math.radians(120))
    HULL_PRESSURE = 0.2
...
IS_FORT_TECH_DRAW_PILLAGED = True
...
class EVENT_CLIENT_DATA:
    ...
    QUEST = 3
    QUEST_REV = 4
    HISTORICAL_BATTLES = 5
    HISTORICAL_BATTLES_REV = 6
    INGAME_EVENTS = 7
    INGAME_EVENTS_REV = 8
    NOTIFICATIONS = 9
