...
if not sum([IS_CHINA, IS_KOREA, IS_SINGAPORE]) <= 1:
    ...
    class ARENA_BONUS_TYPE_CAPS:
        ...
        TOURNAMENT = RESULTS | TKILL_RATING | REPAIR_MECHANICS
        TOURNAMENT_REGULAR = RESULTS | TKILL_RATING | REPAIR_MECHANICS | CREDITS | CREDITS_FACTOR_7X7 | XP | XP_FACTOR_7X7
        TOURNAMENT_CLAN = RESULTS | TKILL_RATING | REPAIR_MECHANICS | CREDITS | CREDITS_FACTOR_7X7 | XP | XP_FACTOR_7X7 | RANSOM_IN | RANSOM_OUT
        ...
        EVENT_BATTLES = RESULTS | DAMAGE_VEHICLE | CREDITS | XP | QUESTS | RESPAWN | INTERACTIVE_STATS | FLAG_MECHANICS | WIN_POINTS_MECHANICS | REPAIR_MECHANICS | TKILL_RATING | MULTITEAMS | RAGE_MECHANICS | RESOURCE_POINTS | DAILY_MULTIPLIED_XP | RENT_BATTLES_COUNTED | BOOSTERS | DOSSIER_FALLOUT | DOSSIER_MAXFALLOUT | DOSSIER_TOTAL | GAS_ATTACK_MECHANICS | DOSSIER_ACHIEVEMENTS_FALLOUT | SQUADS
        FALLOUT = RESULTS | DAMAGE_VEHICLE | CREDITS | XP | QUESTS | RESPAWN | INTERACTIVE_STATS | FLAG_MECHANICS | WIN_POINTS_MECHANICS | REPAIR_MECHANICS | TKILL_RATING | MULTITEAMS | RAGE_MECHANICS | RESOURCE_POINTS | DAILY_MULTIPLIED_XP | RENT_BATTLES_COUNTED | BOOSTERS | DOSSIER_FALLOUT | DOSSIER_MAXFALLOUT | DOSSIER_TOTAL | DOSSIER_ACHIEVEMENTS_FALLOUT | SQUADS
        ...
        _typeToCaps = {ARENA_BONUS_TYPE.REGULAR: REGULAR,
         ...
         ARENA_BONUS_TYPE.FALLOUT: FALLOUT,
    ...
    class UNIT_ASSEMBLER_FLAG:
        ...
        ONLY_NEW_TEAM = 2
        KICK_AFTER_BATTLE = 4
        ALL = (IGNORE_RATING, ONLY_NEW_TEAM, KICK_AFTER_BATTLE)
...
class OVERTURN_CONDITION:
    ...
    COUNTDOWN_COSINE = math.cos(math.radians(80))
    HULL_PRESSURE = 0.2
