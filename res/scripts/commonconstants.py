...
if not sum([IS_CHINA, IS_KOREA, IS_SINGAPORE]) <= 1:
    ...
    class ARENA_BONUS_TYPE_CAPS:
        ...
        COMMON_CHAT = 4611686018427387904L
        ...
        TRAINING = RESULTS | REPAIR_MECHANICS | COMMON_CHAT
        ...
        TOURNAMENT_REGULAR = RESULTS | TKILL_RATING | REPAIR_MECHANICS | CREDITS | CREDITS_FACTOR_7X7 | XP | XP_FACTOR_7X7 | QUESTS | BOOSTERS | DAMAGE_VEHICLE
        TOURNAMENT_CLAN = RESULTS | TKILL_RATING | REPAIR_MECHANICS | CREDITS | CREDITS_FACTOR_7X7 | XP | XP_FACTOR_7X7 | QUESTS | BOOSTERS
