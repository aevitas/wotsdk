...
class LayoutController(BaseMessagesController, EventSystemEntity):
    ...
    def __init__(self, model):
        ...
        self.addListener(VIEW_ALIAS.LOBBY_ACADEMY, self.__onSomeViewSelected, EVENT_BUS_SCOPE.LOBBY)
    ...
    def cleanUp(self):
        ...
        self.removeListener(VIEW_ALIAS.LOBBY_ACADEMY, self.__onSomeViewSelected, EVENT_BUS_SCOPE.LOBBY)
