...
_LOBBY_DEBUG_PACKAGES = ('gui.development.ui.messenger.view',)
_BATTLE_RELEASE_PACKAGES = ()
_BATTLE_DEBUG_PACKAGES = ('gui.development.ui.Scaleform.daapi.view.battle',)
if IS_DEVELOPMENT:
    ...
    COMMON_PACKAGES = _COMMON_RELEASE_PACKAGES + _COMMON_DEBUG_PACKAGES
else:
