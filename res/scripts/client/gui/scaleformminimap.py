...
class Minimap(object):
    ...
    def start(self):
        ...
        if not visitor is not None:
            raise AssertionError('Arena visitor can not be None')
            ...
            self.__marks = {}
            mp = g_sessionProvider.getCtx().isPlayerObserver() or player.getOwnVehicleMatrix()
