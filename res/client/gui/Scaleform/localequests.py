...
class QUESTS(object):
    ...
    SEASONAWARDSWINDOW_BASICAWARDS_TITLE = '#quests:seasonAwardsWindow/basicAwards/title'
    SEASONAWARDSWINDOW_EXTRAAWARDS_TITLE = '#quests:seasonAwardsWindow/extraAwards/title'
